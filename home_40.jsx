...
const postBtnSDM = async (label, setData) => {
  try {
      ...
      <div className='mb-10 flex jcsb'>
        ...
        <div className='flex aic'>
          <div className='flex aic tabs'>
            <a className='tablinks' onClick={() => setData(JSON.parse(storedData))}>
              All
            </a>
            <a className='tablinks' onClick={() => postBtnSDM('Sub', setData)}>
              Sub
            </a>
            <a className='tablinks' onClick={() => postBtnSDM('Dub', setData)}>
              Dub
            </a>
            <a className='tablinks' onClick={() => postBtnSDM('Movie', setData)}>
              Movie
            </a>
            <a className='tablinks' onClick={randomPost}>
              Random
            </a>
          </div>
        </div>
