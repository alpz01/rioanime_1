...
function mainPost(data) {
    data.forEach(post => {
        ...
        GeneratePost(title, score, ep, type, view, imageLink, postLink);
        console.log(`Title: ${title}\nScore: ${score}\nEp: ${ep}\nType: ${type}\nView: ${view}\nImage: ${imageLink}\nPost Link: ${postLink}`);
    });
}


function GeneratePost({ title, score, ep, type, view, imageLink, postLink }) {
    return (
